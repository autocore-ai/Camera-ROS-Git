...
VpsDetector::~TrafficLightsDetector()
{
...
std::vector<int> VpsDetector::visplit(std::string str,std::string pattern)
{
...
bool VpsDetector::roi_region_is_valid()
{
...
bool VpsDetector::load_parameters()
{
...
unsigned char VpsDetector::status_encode(bool go_up,bool go_left,bool go_right)
{
    unsigned char up = 0;
